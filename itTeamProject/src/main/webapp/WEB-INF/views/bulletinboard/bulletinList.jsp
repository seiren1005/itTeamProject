	...
	<div class="">
		<div class="">
			<div class="">
				...
				<form method="get" class="purposeForm" action="/bulletinboard/bulletinList">
				...
				<div class="">
					...
					<div class="">
						<div class="">
							<form id="searchForm" action="/bulletinboard/bulletinList" 
								method="get">
					...
					<!-- Transport page date -->
					<form id="actionForm" 
						action="/bulletinboard/bulletinList" method="get">
...
<script type="text/javascript">
	...
	$("#regBtn").on("click", function() {
		self.location="/bulletinboard/bulletinRegister";
	...
	/* Page processing */
		...
		$(".pageNumBtn a").on("click", function(e) {
			...
			actionForm.attr("action", "/bulletinBoard/bulletinList");
		...
		$(".moveDetails").on("click", function(e) {
			...
			if(actionForm.find("input[name='bno']").val() == null) {
				...
				actionForm.append(
						...
						+ $(this).attr("href") + "' />");
				actionForm.attr("action", "/bulletinboard/bulletinGet");
