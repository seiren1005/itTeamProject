...
<div class="">
	<form role="form" action="/bulletinboard/bulletinModify" method="post">
	...
	$(document).ready(function() {
		...
		$("button").on("click", function(e) {
			...
			if (operation === "update") {
				...
				formObj.attr("action", "/bulletinboard/bulletinRemove");
				...
				// url 로 파라미터 전달
				$(location).attr("href", "/bulletinboard/bulletinGet?bno=" + back_bno);
				return;
				
			} else if (operation === "list") {
				// 이동만 하면 됨
				formObj.attr("action", "/bulletinboard/bulletinList").attr("method", "get");
